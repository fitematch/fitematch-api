...
@ApiBearerAuth('JWT')
@Controller('upload')
export class UploadJobCoverController {
  constructor(private readonly uploadFileService: UploadFileService) {}

  @ApiOperation({ summary: 'Upload recruiter job cover image' })
  ...
  @ApiCreatedResponse({
    description: 'Job cover uploaded successfully.',
  ...
  async handle(
    ...
    return this.uploadFileService.execute({
      file,
      userId: user.id,
      folder: UploadFolderEnum.COVERS,
      resource: UploadResourceEnum.JOB_COVER,
